export default {
  ...
  errorMessages: {
    ...
    needs: 'Please answer this question',
    phoneNumber: 'Please enter a phone number',
    practice: 'Please enter a practice',
    preferredTimes: 'Please enter preferred times',
    priorTherapy: 'Please answer this question',
    priorTreatments: 'Please answer this question',
    provider: 'Please enter a provider',
    ratesDiscussed: 'Please confirm',
    referralConcernMatch: 'Please answer this question',
    school: 'Please enter a school',
    schoolSupport: 'Please answer this question',
